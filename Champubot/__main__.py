# https://github.com/TheChampu/ManagmentBot
...
from Champubot.champu.karma import *
from Champubot import (
    BOT_NAME,
    LOGGER,
    OWNER_ID,
    SUPPORT_CHAT,
...
from Champubot.plugins import ALL_MODULES
from Champubot.plugins.helper_funcs.chat_status import is_user_admin
from Champubot.plugins.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Champubot.plugins." + module_name)
...
async def extra_command_handlered(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [
            InlineKeyboardButton("HOME", callback_data="Champu_back"),
        ],
    ]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            " ˹ᴄʜᴧᴍᴘᴜ˼ ", url="https://t.me/TheChampu"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
...
async def gitsource_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "git_source":
        source_link = "https://github.com/TheChampu/ManagmentBot"
        message_text = (
            f"*Here is the link for the public source repo*:\n\n{source_link}"
        )

        # Adding the inline button
        keyboard = [[InlineKeyboardButton(text="◁", callback_data="Champu_back")]]
        reply_markup = InlineKeyboardMarkup(keyboard)
...
async def Champu_about_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ABOUT", callback_data="Champu_support"
                        ),
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="Champu_back"),
                    ],
                ]
            ),
        )
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="Champu_"),
                    ],
                ]
            ),
        )
...
def main():
    ...
    function(CallbackQueryHandler(Champu_about_callback, pattern=r"Champu_"))
    ...
    LOGGER.info("Champubot is starting >> Using long polling.")
