...
from Champubot import BOT_USERNAME, OWNER_ID, SUPPORT_CHAT
...
START_BTN = [
    ...
    [
        InlineKeyboardButton(text="DETAILS", callback_data="Champu_"),
...
HELP_STRINGS = """
🫧 *ᴄʜᴧᴍᴘᴜ ꭙ ᴍᴧɴᴧɢᴍᴇɴᴛ* 🫧 [ㅤ](https://telegra.ph/file/b05535884267a19ee5c93.jpg)
