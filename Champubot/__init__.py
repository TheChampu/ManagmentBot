...
if ENV:
    ...
    DB_NAME = os.environ.get("DB_NAME", "ChampuDB")
...
# <=============================================== CLIENT SETUP ========================================================>
# Create the Champubot and TelegramClient instances
app = Client("Champubot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
