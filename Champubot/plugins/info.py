...
from Champubot.champu.karma import START_IMG
from Champubot import DEV_USERS, DRAGONS, INFOPIC, OWNER_ID, function
from Champubot.__main__ import STATS, USER_INFO
from Champubot.plugins.helper_funcs.chat_status import support_plus
from Champubot.plugins.users import get_user_id
...
async def info(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_obj.type == ChatType.PRIVATE:
        ...
        if chat_obj.id == OWNER_ID:
            ...
            head += "\n\n🐉 <b>This user is a member of Champu Clan.</b>"
            disaster_level_present = True
...
async def stats(update: Update, context: ContextTypes.DEFAULT_TYPE):
    stats = "📊 <b>Yae Champu Bot's Statistics:</b>\n\n" + "\n".join(
