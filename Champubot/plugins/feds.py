...
from Champubot.plugins.helper_funcs.extraction import (
    extract_unt_fedban,
    extract_user,
    extract_user_fban,
)
from Champubot.plugins.helper_funcs.string_handling import markdown_parser
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "Champubot_fbanned_users.json"
                await update.effective_message.reply_document(
                    document=output,
                    filename="Champubot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "Champubot_fbanned_users.csv"
                await update.effective_message.reply_document(
                    document=output,
                    filename="Champubot_fbanned_users.csv",
