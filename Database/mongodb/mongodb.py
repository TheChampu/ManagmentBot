...
from Champubot import DB_NAME, LOGGER, MONGO_DB_URI

try:
    Champubot_db_client = MongoClient(MONGO_DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
Champubot_main_db = Champubot_db_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = Champubot_main_db[collection]
    ...
    @staticmethod
    def close():
        return Champubot_db_client.close()
